...
@app.route('/mul_numbers', methods=['GET','POST'])
def mul_numbers_post():
	  # --> ['5', '6', '8']
	  # print(type(request.form['text']))
	  if request.method == 'GET':
	  	return render_template('mul_numbers.html')
  	      ...
  	      try:
  	      	for str_num in request.form['text'].split():
  	      		total *= int(str_num)
  	      	return render_template('mul_numbers.html', result=str(total))
  	      except ValueError:
